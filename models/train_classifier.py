...
def tokenize(text):
    ...
    #word token
    token = nltk.tokenize.word_tokenize(processed_text)
    
    #stemming tokens
    stemmer = nltk.stem.PorterStemmer()
    stemmed_words =[stemmer.stem(_word) for _word in token if _word not in nltk.corpus.stopwords.words("english")]
